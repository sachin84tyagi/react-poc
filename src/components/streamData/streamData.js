                    ...
                    >
                        ...
                        <div className="row mt-4">
                                    ...
                                    <table className="table table-dark table-striped">
                                        ...
                                        <tbody>
                                            <tr>
                                                ...
                                                <td>Label</td>
                                                <td>CreatedOn</td>
                                                <td><button className="btn btn-primary" type="submit" onClick={this.onOpenModal}>On</button></td>
                                    ...
                                    <Modal open={open} onClose={this.onCloseModal} center>
                                        ...
                                        <form onSubmit={this.handleSubmit} method="post" id="contactFrm" name="contactFrm">
                                            <div className="modal-header">
                                                <h4 className="modal-title">Modal Heading</h4>
                                            </div>
                                            <div className="modal-body">

                                                <input type="text" onChange={(e) => this.change(e)} placeholder="Please input your Name" value={this.state.name} name="name" className="txt input-sm" />
                                                {this.state.errors['name'] && <small className="text-danger">{this.state.errors['name']}</small>}
                                                <input type="text" onChange={(e) => this.change(e)} placeholder="Please input your mobile No" value={this.state.mob} name="mob" className="txt" />
                                                {this.state.errors['mob'] && <small className="text-danger">{this.state.errors['mob']}</small>}
                                                <input type="text" onChange={(e) => this.change(e)} placeholder="Please input your Email" value={this.state.email} name="email" className="txt" />
